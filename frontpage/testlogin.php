<?php
   ...
   $erreur="";
   if(isset($valider)){
      include("../ressource/db.php");
      $sel=$dbh->prepare("select * from cube2.users where login=? and password=? limit 1");
...
<head>
    ...
    <title>METEO-Lepetit - Connexion</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" name="connexion" method="post" action="">
                                        <div class="form-group">
                                            <input type="text" name="login" class="form-control form-control-user"
                                                id="exampleInputLogin" placeholder="nom de compte">
                                        </div>
                                        <div class="form-group">
